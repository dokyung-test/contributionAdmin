								...
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<div class="form-group" style="width:900px;">
											...
											<label class="label" style="font-size: 25px">제목</label> 
													<input type="text" class="form-control" name="subject" placeholder="제목" style="width:800px;">
									...
									<label class="label" style="font-size: 25px">공지 내용</label>
										...
										<div class="form-group">
											<input type="submit" id="hidden" style="float: right; margin-right: 1%; height: 50px; 
											       width: 150px; font-size: 20px;" value="작성하기" class="btn btn-primary" />
										</div>
									</div>																		
									</div>
								</div>
